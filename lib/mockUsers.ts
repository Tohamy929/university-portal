...
export const MOCK_USERS: User[] = [
  ...
  { id: '32021147', email: 'student1@hti.edu.eg', password: '123', name: 'Ahmed Ali', role: 'student', department: 'Electrical' },
  { id: '32021120', email: 'student2@hti.edu.eg', password: '123', name: 'Sara Mohamed', role: 'student', department: 'Mechanical' },
  { id: '32021130', email: 'student3@hti.edu.eg', password: '123', name: 'Omar Gad', role: 'student', department: 'Vehicle' },
  { id: '32021140', email: 's4@hti.edu.eg', password: '123', name: 'Sheriff Mahmoud', role: 'student', department: 'Electrical' },
{ id: '32021150', email: 's5@hti.edu.eg', password: '123', name: 'Youssef Sedik', role: 'student', department: 'Electrical' },
{ id: '32021160', email: 's6@hti.edu.eg', password: '123', name: 'Hana El-Sayed', role: 'student', department: 'Mechanical' },
